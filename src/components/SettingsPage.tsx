            ...
            <div className="space-y-8">
                ...
                <section className="space-y-5">
                    ...
                    <div className="p-5 rounded-xl bg-white/[0.02] border border-white/5 space-y-5">
                        ...
                        <OptionGroup label="리뷰 톤" options={toneOptions} value={tone} onChange={setTone} />
                        <OptionGroup label="리뷰 포커스" options={focusOptions} value={focus} onChange={setFocus} />
                        <OptionGroup label="상세 수준" options={detailOptions} value={detailLevel} onChange={setDetailLevel} />
                ...
                <section className="space-y-5">
                    ...
                    <div className="p-5 rounded-xl bg-white/[0.02] border border-white/5 space-y-4">
                        <div className="text-[13px] font-medium text-white">OpenAI API 키</div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full p-3 pr-10 bg-white/[0.03] border rounded-lg text-[13px] text-white placeholder-slate-600 focus:outline-none focus:border-white/20 font-mono transition-colors ${apiKey.startsWith('sk-') && apiKey.includes('****')
